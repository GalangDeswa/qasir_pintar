...
class EditKategoriPelangganController extends GetxController {
  @override
  void onInit() {
    // TODO: implement onInit
    super.onInit();
    nama.value.text = data.kategori!;
    logo.value = data.ikon ?? '-';
    isAktif.value = data.status == 1 ? true : false;
  }
  ...
  editKategoriPelangganlocal() async {
