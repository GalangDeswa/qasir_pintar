...
class DetailHistoryPenjualanController extends GetxController {
  ...
  Future<void> onInit() async {
    ...
    super.onInit();
    await fetchDetailRiwayat(id_toko: id_toko, id_penjualan: data.uuid);
    nomorfaktur.value.text = data.noFaktur!;
    jumlahqty.value.text = data.totalQty.toString();
    subtotal.value.text = data.subtotal.toString();
    totalbayar.value.text = data.totalBayar.toString();
    tanggal.value.text = data.tanggal!;
    totaldiskon.value.text = data.totalDiskon.toString();
    diskonnominal.value.text = data.diskonNominal.toString();
    diskonpersen.value.text = data.diskonPersen.toString();
    ...
    dataprint = DataPenjualan(
      ...
      nilaiBayar: data.nilaiBayar,
      nilaiPromo: data.nilaiPromo,
    ...
    itemprint = List.from(detailpenjualan);
  }

  DataPenjualan data = Get.arguments;
  ...
  var kodepromo = TextEditingController().obs;
  var nilaipromo = TextEditingController().obs;
  var tanggal = TextEditingController().obs;
  var pelanggan = TextEditingController().obs;
  var totaldiskon = TextEditingController().obs;
  var diskonnominal = TextEditingController().obs;
  var diskonpersen = TextEditingController().obs;
  ...
  printstruk() {
    ...
    final List<DataDetailPenjualan> daftarItem = List.from(detailpenjualan);
                ...
                Expanded(
                  child: button_solid_custom(
                      onPressed: () {
                        ...
                        subtotal.value.text = harga_modal.value.toString();
                        hpp.value.text = harga_hpp.value.toString();
                        print('sum harga modal --->' +
                            harga_modal.value.toString());
                        print(
  ...
  var subtotal = TextEditingController().obs;
  ...
  var detailpenjualan = <DataDetailPenjualan>[].obs;

  fetchDetailRiwayat({id_toko, id_penjualan}) async {
  ...
  cariTotalBayar() {
    var x = double.parse(subtotal.value.text);
  ...
  tambahPenerimaanProduk() async {
    ...
    var paket = await DBHelper().INSERT(
      ...
      DataPenerimaanProduk(
              ...
              totalHarga: double.parse(subtotal.value.text),
