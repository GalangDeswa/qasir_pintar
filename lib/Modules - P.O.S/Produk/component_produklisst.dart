...
class ProdukList extends GetView<BaseMenuProdukController> {
                        ...
                        child: ListTile(
                          leading: ClipOval(
                            child: customer[index].ikon != '-'
                                ? controller.isBase64Svg(customer[index].ikon!)
                                    ? SvgPicture.memory(
                                        base64Decode(customer[index].ikon!),
                                        width: 60,
                                        height: 70,
                                        fit: BoxFit.cover,
                                      )
