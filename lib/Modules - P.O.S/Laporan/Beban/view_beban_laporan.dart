...
class BebanLaporan extends GetView<BebanLaporanController> {
  const BebanLaporan({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            button_solid_custom(
                ...
                width: Get.width),
            Obx(() {
              return controller.summaryBeban.isEmpty
                  ? Container()
                  : button_border_custom(
                      onPressed: () {
                        controller.createPDF(
                          summaryList: controller.summaryBeban,
            ...
            Obx(() {
              final list = controller.summaryBeban;
              if (list.isEmpty) {
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          Expanded(
                                            child: ListTile(
                                              title: Text("Nama Beban"),
                                              subtitle: Text(item.namaBeban),
                                              contentPadding: EdgeInsets.zero,
                                            ),
                                          ),
                                          Expanded(
                                            child: ListTile(
                                              title: Text("diinput oleh "),
                                              subtitle: Text(item.namaKaryawan),
                                              contentPadding: EdgeInsets.zero,
                                            ),
                                          ),
                                        ],
                                      ...
                                      Row(
                                        children: [
                                          Expanded(
                                            child: ListTile(
                                              title: Text("Total beban"),
                                              subtitle: Text(
                                                  item.countEntries.toString()),
                                              contentPadding: EdgeInsets.zero,
                                            ),
                                          ),
                                          Expanded(
                                            child: ListTile(
                                              title: Text("Total jumlah"),
