...
import '../../Produk/add/controller_tambahproduk.dart';
...
//                               borderRadius: BorderRadius.circular(10),
//                               color: Colors.white)),
//                       hint: Text('Harga jual', style: AppFont.regular()),
//                       value: controller.hargaJualUtamaValue,
//                       items: controller.hargaJualUtamaList.map((x) {
//                         return DropdownMenuItem(
//                           child: Text(x.harga_jual.toString()),
//                           value: x.uuid,
//                         );
//                       }).toList(),
//                       onChanged: (val) {
//                         print('asdasdasdasd');
//                         controller.hargaJualUtamaValue = val;
//                         print(controller.hargaJualUtamaValue);
//                       },
//                     ),
//                   );
//                 }),
...
//                               borderRadius: BorderRadius.circular(10),
//                               color: Colors.white)),
//                       hint: Text('Satuan', style: AppFont.regular()),
//                       value: controller.satuanUtamaValue,
//                       items: controller.satuanUtamaList.map((x) {
//                         return DropdownMenuItem(
//                           child: Text(x.nama_satuan!),
//                           value: x.uuid,
//                         );
//                       }).toList(),
//                       onChanged: (val) {
//                         print('asdasdasdasd');
//                         controller.satuanUtamaValue = val;
//                         print(controller.satuanUtamaValue);
//                       },
//                     ),
//                   );
//                 }),
...
//                               borderRadius: BorderRadius.circular(10),
//                               color: Colors.white)),
//                       hint: Text('Isi per satuan', style: AppFont.regular()),
//                       value: controller.isiDalamSatuanValue,
//                       items: controller.isiDalamSatuanList.map((x) {
//                         return DropdownMenuItem(
//                           child: Text(x.isi_per_satuan.toString()),
//                           value: x.uuid,
//                         );
//                       }).toList(),
//                       onChanged: (val) {
//                         print('asdasdasdasd');
//                         controller.isiDalamSatuanValue = val;
//                         print(controller.isiDalamSatuanValue);
//                       },
//                     ),
//                   );
//                 }),
...
//                               borderRadius: BorderRadius.circular(10),
//                               color: Colors.white)),
//                       hint: Text('Pajak', style: AppFont.regular()),
//                       value: controller.pajakValue,
//                       items: controller.pajakList.map((x) {
//                         return DropdownMenuItem(
//                           child: Text(x.nama_pajak!),
...
//                 //       child: TextFormField(
//                 //         controller: controller.warna.value,
//                 //         decoration: InputDecoration(
//                 //           labelText: 'Warna',
//                 //           border: OutlineInputBorder(
//                 //             borderRadius: BorderRadius.circular(10),
...
//                               borderRadius: BorderRadius.circular(10),
//                               color: Colors.white)),
//                       hint: Text('Ukuran', style: AppFont.regular()),
//                       value: controller.ukuranValue,
//                       items: controller.ukuranList.map((x) {
//                         return DropdownMenuItem(
//                           child: Text(x.ukuran!),
