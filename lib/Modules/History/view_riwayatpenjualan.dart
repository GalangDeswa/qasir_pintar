...
import 'package:qasir_pintar/Modules/History/controller_riwayatpenjualan.dart';
...
class HistoryPenjualan extends GetView<HistoryPenjualanController> {
  const HistoryPenjualan({super.key});
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [Text('Riwayat Penjualan'), Text('Aksi')],
            ),
          ),
          Container(
            height: 0.9,
          ...
          Obx(() {
            return Expanded(
              child: controller.penjualan.isNotEmpty
                  ? ListView.builder(
                      itemCount: controller.penjualan.length,
                      itemBuilder: (context, index) {
                        final penjualan = controller.penjualan;
                        ...
                        return custom_list(
                          ...
                          subtitle: penjualan[index].tanggal,
                          title: penjualan[index].noFaktur,
                          gestureroute: '/detail_history',
                          gestureArgument: penjualan[index],
                        );
                      },
                    )
                  : EmptyData(),
...
abstract class MenuItems {
  ...
  static void onChanged(BuildContext context, MenuItem item,
      HistoryPenjualanController controller, DataPenjualan data) {
    switch (item) {
      case MenuItems.Edit:
        print('edit');
