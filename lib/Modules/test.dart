...
class PhysicsAndSnapGridExample extends StatelessWidget {
  const PhysicsAndSnapGridExample();
...
var _sheetHeight = Get.height * 0.5;
  ...
  SheetSnapGrid createSnapGrid() {
    return switch (snapGridKind) {
      ...
      _SnapGridKind.multi => const MultiSnapGrid(
          snaps: [SheetOffset(0.3), SheetOffset(0.6), SheetOffset(1)],
        ),
    };
  }
